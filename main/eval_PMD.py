...
pred_dir = "/home/gpuadmin/hds/mirror_rorate/HetNet/Test_model_result/2024-11-29_19-50_best_mae.pth/MSD/PMD"
...
for name in os.listdir(os.path.join(pred_dir)):
    ...
    if gt.ndim == 3:
        gt = gt[:, :, 0]  # Take the first channel or use np.mean(gt, axis=-1)  新增
